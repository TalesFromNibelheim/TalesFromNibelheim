...
public class GamePlayerMageTest {
    ...
    public void addCardTest()
    {
        ...
        Card card = new CardItem(1,2,3,4,0,2,3, PlayerMage.class);
        assertTrue(player.addCard(card));
        Card card1 = new CardItem(3,4,5,7,0,4,3,PlayerMage.class);
    ...
    public void removeCardTest()
    {
        ...
        Card card = new CardItem(1,2,3,4,0,2,3, PlayerMage.class);
        Card card1 = new CardItem(3,4,5,7,0,4,3,PlayerMage.class);
        Card card2 = new CardItem(4,5,6,4,0,1,4,PlayerMage.class);
        card.setName("C1");
        card1.setName("C2");
        card2.setName("C3");
        player.addCard(card);
        ...
        for (ICard iCard : tempCard) assertFalse(iCard.getName().equals(card.getName()));
        player.removeCard("C2");
        for (ICard iCard : tempCard) assertFalse(iCard.getName().equals(card1.getName()));
        player.removeCard("C3");
        for (ICard iCard : tempCard) assertFalse(iCard.getName().equals(card2.getName()));
    }
...
//        ICard card = new CardItem(1,2,3,4,0,2,3, PlayerMage.class);
//        player.addCard(card);
//        player.recalculateAttributes();
