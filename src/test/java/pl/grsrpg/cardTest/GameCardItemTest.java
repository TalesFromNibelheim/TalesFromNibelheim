...
public class GameCardItemTest {
    ...
    public void increaseAttributesWarriorTest(){
        Card card = new CardItem(1,2,3,4,0,2,3, PlayerWarrior.class);
    ...
    {
        Card card = new CardItem(7,4,1,2,0,10,3, PlayerScout.class);
    ...
    {
        Card card = new CardItem(8,7,6,5,0,11,4, PlayerScout.class);
        Player player = new PlayerScout();
        player.setEquipmentCapacity(2);
        card.execute(player);
    ...
    {
        Card card = new CardItem(8,7,6,5,0,11,4, PlayerWarrior.class);
        Player player = new PlayerScout();
        card.execute(player);
    ...
    {
        Card card = new CardItem(0,0,0,0,1000,1000,0,null);
        Player player = new PlayerWarrior();
        card.execute(player);
